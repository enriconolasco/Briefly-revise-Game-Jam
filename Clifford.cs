...
public class Clifford : Player2DController
{
    ...
    public override void Shoot()
    {
        if (facingForward)
        {
            ...
            instance.GetComponent<Rigidbody2D>().AddForce(new Vector3(2.3f, -0.5f, 0.0f) * shootForce);
            ...
            instance2.GetComponent<Rigidbody2D>().AddForce(new Vector3(2.3f, 0.5f, 0.0f) * shootForce);
            ...
            instance3.GetComponent<Rigidbody2D>().AddForce(new Vector3(2.3f, 0.0f, 0.0f) * shootForce);
